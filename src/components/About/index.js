      ...
      <div className="flex flex-row  gap-6 ml-8">
        <div className="flex-col mt-14 flex flex-auto w-64 gap-6">
          <h3 className="text-3xl font-medium" data-aos={"fade-left"}>
            I'm <span className="text-yellow-600">Joshua D. Nguyen,</span> a GameDev
            Enthusiast
          </h3>
          <p
            ...
            data-aos={"fade-left"}
          >
            I love playing video games, reading books, and listening to podcasts. I am
            a mid level engineer who is trying to get a proper start in the game industry with
            right mentorship. I am {getDate()}{" "}
